...
func _process(delta: float) -> void:
	...
	if gm.current_energy_cat < card_change_energy_cost and free_changes == 0:
...
func _on_card_played(played_card: Control) -> void:
	...
	get_parent().get_parent().giant.current_energy -= current_selected.energy_cost
...
func _on_change_button_pressed() -> void:
	...
	if get_parent().get_parent().giant.current_energy - card_change_energy_cost >= 0:
		$AudioStreamPlayerChange.play()
		get_parent().get_parent().giant.current_energy -= card_change_energy_cost
...
func _on_end_button_pressed() -> void:
	get_parent().get_parent().giant.current_energy = -1000
