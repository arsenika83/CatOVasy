...
"shashlyck", "inferno", "revenge", "cattenheimer", "lick_wounds", "compensation", "eclipse"]
...
var all_card_names_unbelievable_cat : Array[String] = ["eclipse"]
...
"wind_of_change", "dont_hit","big_fire", "sand_in_the_eyes"]
