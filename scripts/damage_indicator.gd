...
func display_damage(amount, start_position: Vector2) -> void:
	...
	if int(amount) < 0: 
		text = str("[outline_size=4][outline_color=#2f94cf][color=#FFFFFF]+ ", -amount, " [/color][/outline_color][/outline_size]")
	elif int(amount) == 0: 
		...
		text = str("[outline_size=4][outline_color=#930609][color=#FFFFFF]", amount, " [/color][/outline_color][/outline_size]")
	elif int(amount) > 50 and int(amount) <= 100:
		text = str("[outline_size=4][outline_color=#ff34d3][color=#FFFFFF]", amount, " [/color][/outline_color][/outline_size]")	
	else:
		text = str("[outline_size=4][outline_color=#ff0082][color=#FFFFFF]", amount, " [/color][/outline_color][/outline_size]")
	...
	tween.tween_property(self, "modulate:a", 0.0, 1.5).set_delay(life_time)
